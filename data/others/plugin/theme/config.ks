...
tf.config_x	 		 = [1587, 690, 774, 858, 942, 1026, 1110, 1194, 1278, 1362, 1446];
tf.config_y 		 = [270, 375, 480, 585];
tf.img_width 		 = 54;
tf.img_height 		 = 54;
tf.config_num_bgm;
tf.config_num_se;
...
switch(tf.current_auto_speed) {
	...
	case  785: tf.config_num_auto =  8; break;
...
[button fix="true" graphic="&tf.img_path + 'back.png'" enterimg="&tf.img_path + 'back2.png'" target="*backtitle" x="0" y="980"]
...
; BGMミュート
[button name="bgmvol,bgmvol_0"   fix="true" target="*vol_bgm_mute" graphic="&tf.btn_path_off" width="108" height="54" x="1587" y="267"]

;-------------------------------------------------------------------------------
; SE音量
;-------------------------------------------------------------------------------
[button name="sevol,sevol_10"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[1]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  10; tf.config_num_se =  1" clickse="0.ogg"]
[button name="sevol,sevol_20"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[2]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  20; tf.config_num_se =  2" clickse="0.ogg"]
[button name="sevol,sevol_30"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[3]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  30; tf.config_num_se =  3" clickse="0.ogg"]
[button name="sevol,sevol_40"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[4]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  40; tf.config_num_se =  4" clickse="0.ogg"]
[button name="sevol,sevol_50"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[5]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  50; tf.config_num_se =  5" clickse="0.ogg"]
[button name="sevol,sevol_60"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[6]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  60; tf.config_num_se =  6" clickse="0.ogg"]
[button name="sevol,sevol_70"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[7]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  70; tf.config_num_se =  7" clickse="0.ogg"]
[button name="sevol,sevol_80"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[8]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  80; tf.config_num_se =  8" clickse="0.ogg"]
[button name="sevol,sevol_90"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[9]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  90; tf.config_num_se =  9" clickse="0.ogg"]
[button name="sevol,sevol_100" fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[10]" y="&tf.config_y[1]" exp="tf.current_se_vol = 100; tf.config_num_se = 10" clickse="0.ogg"]

; SEミュート
[button name="sevol,sevol_0"   fix="true" target="*vol_se_mute" graphic="&tf.btn_path_off" width="108" height="54" x="1587" y="372" clickse="0.ogg"]
...
[button name="auto,auto_785"  fix="true" target="*auto_speed_change" graphic="&tf.btn_path_off" width="&tf.img_width" height="&tf.img_height" x="&tf.config_x[9]"  y="&tf.config_y[3]" exp="tf.set_auto_speed =  785; tf.config_num_auto = 8"]
...
;-------------------------------------------------------------------------------
; 未読スキップ-ON
[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" width="216" height="54" x="600" y="690"]

; 未読スキップ-OFF
[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" width="216" height="54" x="785" y="690"]

;-------------------------------------------------------------------------------
; 画面サイズ
;-------------------------------------------------------------------------------
; フルスクリーン
[button name="screen_full" fix="true" target="*screen_full" graphic="&tf.btn_path_off" width="216" height="54" x="1250" y="690"]

; ウィンドウサイズ
[button name="screen_window" fix="true" target="*screen_window" graphic="&tf.btn_path_off" width="216" height="54" x="1435" y="690"]
...
[image layer="0" name="unread_off" storage="../others/plugin/theme/image/config/skipoff.png" x="785" y="690"]
...
[image layer="0" name="unread_on" storage="../others/plugin/theme/image/config/skipon.png" x="600" y="690"]
...
[if exp="tf.screen_size == 'window'"]
	...
	[image layer="0" name="screen_full" storage="../others/plugin/theme/image/config/full.png" x="1250" y="690"]
...
[if exp="tf.screen_size == 'full'"]
	...
	[image layer="0" name="screen_window" storage="../others/plugin/theme/image/config/window.png" x="1435" y="690"]
...
[if exp="tf.config_num_bgm == 0"]
	[image layer="0" name="bgmvol" storage="&tf.img_path + 'mute.png'" x="1587" y="267"]
[else]
...
[if exp="tf.config_num_se == 0"]
	[image layer="0" name="sevol" storage="&tf.img_path + 'mute.png'" x="1587" y="372"]
[else]
